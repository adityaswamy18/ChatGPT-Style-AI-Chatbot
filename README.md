...
💬 Contextual memory using Buffer Memory to store previous conversation history

🔗 Webhook-based API for sending prompts and receiving responses

⚙️ Modular n8n Workflow – easy to modify and scale
